...
namespace CapaControlador_prototipoumg2k26
{
    public class ModeloCampeonato
    {
        ...
        [RegularExpression(@"^[a-zA-Z0-9á-úÁ-ÚñÑ\s]+$", ErrorMessage = "El nombre solo puede contener letras, números y espacios")]
        public string NombreCampeonato { get => _NombreCampeonato; set => _NombreCampeonato = value; }

        [Required(ErrorMessage = "La fecha de inicio es requerida")]
        public DateTime FechaInicioCampeonato { get => _FechaInicioCampeonato; set => _FechaInicioCampeonato = value; }

        [Required(ErrorMessage = "La fecha de finalización es requerida")]
        public DateTime FechaFinCampeonato { get => _FechaFinCampeonato; set => _FechaFinCampeonato = value; }

        [Required(ErrorMessage = "Debe seleccionar un deporte")]
        [Range(1, int.MaxValue, ErrorMessage = "Debe seleccionar un deporte válido")]
        public int IdDeporte_Campeonato { get => _IdDeporte_Campeonato; set => _IdDeporte_Campeonato = value; }

        [Required(ErrorMessage = "Debe seleccionar un tipo de campeonato")]
        [Range(1, int.MaxValue, ErrorMessage = "Debe seleccionar un tipo de campeonato válido")]
        public int IdTipoCampeonato_Campeonato { get => _IdTipoCampeonato_Campeonato; set => _IdTipoCampeonato_Campeonato = value; }
        ...
        public int IdEstado_Campeonato { get => _IdEstado_Campeonato; set => _IdEstado_Campeonato = value; }
        ...
        public string GrabarCambios()
        {
            ...
            try
            {
                ...
                modeloDatosCampeonato.IdDeporte_Campeonato = _IdDeporte_Campeonato;
                modeloDatosCampeonato.IdTipoCampeonato_Campeonato = _IdTipoCampeonato_Campeonato;
                modeloDatosCampeonato.IdEstado_Campeonato = _IdEstado_Campeonato;

                switch (Estado)
                {
                    case EstadoEntidad.Added:
                        RepositorioCampeonato.Agregar(modeloDatosCampeonato);
                        mensaje = "Grabacion exitosa";
                        break;
                    case EstadoEntidad.Modified:
                        RepositorioCampeonato.Editar(modeloDatosCampeonato);
                        mensaje = "Actualizacion exitosa";
                        break;
                    case EstadoEntidad.Deleted:
                        RepositorioCampeonato.Remover(modeloDatosCampeonato);
        ...
        public List<ModeloCampeonato> GetAll()
        {
            ...
            {
                ListaCampeonatos.Add(new ModeloCampeonato
                {
                    _IdCampeonato = item.IdCampeonato,
                    _NombreCampeonato = item.NombreCampeonato,
                    _FechaInicioCampeonato = item.FechaInicioCampeonato,
                    _FechaFinCampeonato = item.FechaFinCampeonato,
                    _IdDeporte_Campeonato = item.IdDeporte_Campeonato,
                    _IdTipoCampeonato_Campeonato = item.IdTipoCampeonato_Campeonato,
                    _IdEstado_Campeonato = item.IdEstado_Campeonato
                });
            }
        ...
        {
            return ListaCampeonatos.FindAll(e => e.NombreCampeonato.Contains(filter) || e.IdCampeonato.ToString().Contains(filter));
        }
    }
}